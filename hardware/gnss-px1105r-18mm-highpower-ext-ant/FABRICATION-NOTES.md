# GNSS PX1105R carrier — fabrication and assembly notes
...
| Item | Value | Why |
|---|---|---|
| Stencil | **100 µm (4 mil)**, flat, no step. Laser cut, electropolished and nano-coated. | Repo default set 2026-09-09 (#959). Tightest aperture on this board is F.Cu U3 TPS62913RPUR 0.65 x 0.20 mm at **AR 0.76** on a 100 µm foil, against the IPC-7525 floor of 0.66. Nothing here needs a foil thinner than **116 µm**, so 100 µm is the fleet default rather than a board constraint. |
