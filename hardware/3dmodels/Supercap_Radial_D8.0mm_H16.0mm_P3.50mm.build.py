...
# lead type, spec date 2022-06-10 -- 3.0 F in an 8 x 16 can (D +/-1.0, L +/-1.5),
# leads 0.6 mm on a 3.5 mm pitch (+/-0.5). Drawn at nominal size in the footprint
# frame of Supercap_Radial_D8.0mm_H16.0mm_P3.50mm: pad 1 (+) at the origin, pad 2
...
D, L = 8.0, 16.0        # can diameter and length
...
assy = cq.Assembly(name="Supercap_Radial_D8_H16")
...
assy.export("Supercap_Radial_D8.0mm_H16.0mm_P3.50mm.step")
