# Tinker-Beetle (rocket computer mini) — fabrication and assembly notes
...
B1. *** STENCIL FOIL 0.08 mm (3 mil), FLAT - NO STEP. ***
    A DELIBERATE EXCEPTION TO THE 0.10 mm REPO DEFAULT -
    SEE hardware/SOLDER-PASTE-CONVENTION.md (#959, #906).
...
- **`J8` paste apertures (B7a) — next spin.** The shared `Footprints:CON-SMA-EDGE-S` footprint
  pastes all five pads, and on every board that uses it (`lora-daughterboard`, `tinker-base`,
