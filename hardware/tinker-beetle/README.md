...
> **Tinker-Beetle** is the product name, from 2026-09-24, of the board this
> repo called `rocket-computer-mini`. The old name stays below wherever it is
> history: the fab tags (`rocket-computer-mini-v1.0.1`), and comparisons with
> `rocket-computer`, which is now the [Tinker-Mantis](../tinker-mantis/). The
> firmware calls this board `M1`.

A reduced-capability flight computer. The design starts from a copy of
[`rocket-computer/`](../tinker-mantis/) (since renamed `tinker-mantis/`) as it
stood at the fork point, and
...
- **`power-eco.md`** and **`high-side-switch-design.md`** — design rationale for
  ...
  [`../tinker-mantis/`](../tinker-mantis/) rather than in a copy here that
  would drift.
...
[`projects/rocket_computer_mini`](../../tinkerrocket-idf/projects/legacy/rocket_computer_mini/),
