# Tinker-Beetle (rocket-computer-mini) — 3V3 budget
...
[`../tinker-base/`](../tinker-base/); identity lives in those BOMs.
...
[`../tinker-mantis/power-eco.md`](../tinker-mantis/power-eco.md) puts that
...
[`../tinker-base/`](../tinker-base/), which was recently reworked.
That would be a mistake, and the reason is the battery, not the load:

| | Tinker-Base (base-station-mini) | Tinker-Beetle (rocket-computer-mini) |
|---|---|---|
...
3. **Branch switching — decided 2026-08-22.** The GNSS receiver and the radio
   ...
   [`../tinker-mantis/high-side-switch-design.md`](../tinker-mantis/high-side-switch-design.md)).
...
([`../tinker-mantis/power-eco.md`](../tinker-mantis/power-eco.md)). **Both
