...
B0. *** STENCIL FOIL 0.10 mm (4 mil), FLAT - NO STEP.
    ...
    AREA RATIO AT 0.10 mm, TIGHTEST APERTURE PER SIDE:
      F.Cu  Q9 PMPB14XNX 0.330 x 0.250 POLYS   AR 0.71
            U17 ESP32-P4 0.65 x 0.18 OVALS     AR 0.73
      B.Cu  U23 INA230 EPAD CORNER WINDOWS
            0.281 x 0.281 (x4)                 AR 0.70
    THE IPC-7525 FLOOR IS 0.66, SO EVERY APERTURE CLEARS,
    THE TIGHTEST BY 6 PERCENT. DO NOT SUBSTITUTE A THICKER
    FOIL: AT 0.13 mm U17 FALLS TO AR 0.54. A COATED FOIL IS
    NOT OPTIONAL AT THIS RATIO - IT IS WHAT MAKES THE
    RELEASE RELIABLE.
