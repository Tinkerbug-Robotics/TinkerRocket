...
`TinkerRocketApp/TinkerRocketApp` is 34,724 lines across 88 Swift files, grouped by directory.
...
| [TelemetryData.swift](https://github.com/Tinkerbug-Robotics/TinkerRocket/blob/main/TinkerRocketApp/TinkerRocketApp/Models/TelemetryData.swift) | 938 | `TelemetryData` |
