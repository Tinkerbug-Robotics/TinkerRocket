...
`TinkerRocketApp/TinkerRocketApp` is 32,391 lines across 81 Swift files, grouped by directory.
...
## `Models/` — 40 files, 15,589 lines

| File | Lines | Declares |
|------|-------|----------|
| [BLEDevice.swift](https://github.com/Tinkerbug-Robotics/TinkerRocket/blob/main/TinkerRocketApp/TinkerRocketApp/Models/BLEDevice.swift) | 2,627 | `BLEDeviceType`, `BLEDevice` |
...
| [FileCache.swift](https://github.com/Tinkerbug-Robotics/TinkerRocket/blob/main/TinkerRocketApp/TinkerRocketApp/Models/FileCache.swift) | 544 | `FlightSummaryHeadline`, `CachedFlightType`, `CachedFlight` |
...
## `Views/` — 30 files, 15,731 lines

| File | Lines | Declares |
|------|-------|----------|
| [DashboardView.swift](https://github.com/Tinkerbug-Robotics/TinkerRocket/blob/main/TinkerRocketApp/TinkerRocketApp/Views/DashboardView.swift) | 3,493 | `IdentifiableInt`, `DashboardSheet`, `DashboardVisibility`, `DashboardView`, `ConnectedFleetView`, `DirectRocketSection`, +42 more |
