...
`TinkerRocketApp/TinkerRocketApp` is 32,950 lines across 82 Swift files, grouped by directory.
...
## `Models/` — 41 files, 16,004 lines

| File | Lines | Declares |
|------|-------|----------|
| [BLEDevice.swift](https://github.com/Tinkerbug-Robotics/TinkerRocket/blob/main/TinkerRocketApp/TinkerRocketApp/Models/BLEDevice.swift) | 2,636 | `BLEDeviceType`, `BLEDevice` |
...
| [EspImage.swift](https://github.com/Tinkerbug-Robotics/TinkerRocket/blob/main/TinkerRocketApp/TinkerRocketApp/Models/EspImage.swift) | 163 | `EspAppImage`, `EspImageVerdict`, `EspImage` |
...
| [FirmwareUpdateView.swift](https://github.com/Tinkerbug-Robotics/TinkerRocket/blob/main/TinkerRocketApp/TinkerRocketApp/Views/FirmwareUpdateView.swift) | 387 | `FirmwareUpdateView`, `FirmwareUpdateContent`, `LabeledRow` |
