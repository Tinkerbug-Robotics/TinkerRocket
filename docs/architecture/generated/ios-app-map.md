...
`TinkerRocketApp/TinkerRocketApp` is 30,402 lines across 76 Swift files, grouped by directory.
...
## `Models/` — 36 files, 14,261 lines

| File | Lines | Declares |
|------|-------|----------|
| [BLEDevice.swift](https://github.com/Tinkerbug-Robotics/TinkerRocket/blob/main/TinkerRocketApp/TinkerRocketApp/Models/BLEDevice.swift) | 2,407 | `BLEDeviceType`, `BLEDevice` |
...
## `Views/` — 30 files, 15,225 lines

| File | Lines | Declares |
|------|-------|----------|
| [DashboardView.swift](https://github.com/Tinkerbug-Robotics/TinkerRocket/blob/main/TinkerRocketApp/TinkerRocketApp/Views/DashboardView.swift) | 3,332 | `IdentifiableInt`, `DashboardSheet`, `DashboardVisibility`, `DashboardView`, `ConnectedFleetView`, `DirectRocketSection`, +41 more |
