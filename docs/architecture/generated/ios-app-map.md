...
`TinkerRocketApp/TinkerRocketApp` is 32,079 lines across 81 Swift files, grouped by directory.
...
| [TelemetryData.swift](https://github.com/Tinkerbug-Robotics/TinkerRocket/blob/main/TinkerRocketApp/TinkerRocketApp/Models/TelemetryData.swift) | 873 | `TelemetryData` |
| &nbsp;&nbsp;&nbsp;&nbsp;↳ *sections* | | Hold-up capacitor (#1166) |
...
## `Views/` — 30 files, 15,632 lines

| File | Lines | Declares |
|------|-------|----------|
| [DashboardView.swift](https://github.com/Tinkerbug-Robotics/TinkerRocket/blob/main/TinkerRocketApp/TinkerRocketApp/Views/DashboardView.swift) | 3,453 | `IdentifiableInt`, `DashboardSheet`, `DashboardVisibility`, `DashboardView`, `ConnectedFleetView`, `DirectRocketSection`, +42 more |
