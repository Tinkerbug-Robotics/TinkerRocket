...
`TinkerRocketApp/TinkerRocketApp` is 26,901 lines across 70 Swift files, grouped by directory.
...
## `Models/` — 33 files, 12,090 lines

| File | Lines | Declares |
|------|-------|----------|
| [BLEDevice.swift](https://github.com/Tinkerbug-Robotics/TinkerRocket/blob/main/TinkerRocketApp/TinkerRocketApp/Models/BLEDevice.swift) | 2,059 | `BLEDeviceType`, `BLEDevice` |
...
## `Views/` — 27 files, 13,901 lines

| File | Lines | Declares |
|------|-------|----------|
| [DashboardView.swift](https://github.com/Tinkerbug-Robotics/TinkerRocket/blob/main/TinkerRocketApp/TinkerRocketApp/Views/DashboardView.swift) | 3,028 | `IdentifiableInt`, `DashboardSheet`, `DashboardView`, `ConnectedFleetView`, `DirectRocketSection`, `FocusedRelaySection`, +40 more |
...
| [PyroTestView.swift](https://github.com/Tinkerbug-Robotics/TinkerRocket/blob/main/TinkerRocketApp/TinkerRocketApp/Views/PyroTestView.swift) | 537 | `PyroTestState`, `TickCounter`, `PyroTestView`, `SlowMoCameraManager`, `CameraPreviewView` |
