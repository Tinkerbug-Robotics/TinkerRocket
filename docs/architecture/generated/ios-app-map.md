...
`TinkerRocketApp/TinkerRocketApp` is 34,240 lines across 87 Swift files, grouped by directory.
...
| [TelemetryData.swift](https://github.com/Tinkerbug-Robotics/TinkerRocket/blob/main/TinkerRocketApp/TinkerRocketApp/Models/TelemetryData.swift) | 924 | `TelemetryData` |
