...
`TinkerRocketApp/TinkerRocketApp` is 32,269 lines across 81 Swift files, grouped by directory.
...
## `Models/` — 40 files, 15,470 lines

| File | Lines | Declares |
|------|-------|----------|
| [BLEDevice.swift](https://github.com/Tinkerbug-Robotics/TinkerRocket/blob/main/TinkerRocketApp/TinkerRocketApp/Models/BLEDevice.swift) | 2,583 | `BLEDeviceType`, `BLEDevice` |
