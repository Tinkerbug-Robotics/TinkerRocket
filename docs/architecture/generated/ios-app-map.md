...
`TinkerRocketApp/TinkerRocketApp` is 26,874 lines across 70 Swift files, grouped by directory.
...
## `Models/` — 33 files, 12,103 lines

| File | Lines | Declares |
|------|-------|----------|
| [BLEDevice.swift](https://github.com/Tinkerbug-Robotics/TinkerRocket/blob/main/TinkerRocketApp/TinkerRocketApp/Models/BLEDevice.swift) | 2,031 | `BLEDeviceType`, `BLEDevice` |
