...
| — | **Shadow-phone field outing** | Android as second phone at a real launch (iOS primary, both on the same BS) — zero-stakes field validation of connect/dashboard/map/voice | Field notes; fixes | 2–4 |
