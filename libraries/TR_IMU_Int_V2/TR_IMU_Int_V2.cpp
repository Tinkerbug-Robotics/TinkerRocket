...
{ 
    ...
    if (debug_request_)
    {
        Serial.print("dt_s_: ");Serial.println(dt_s_,5);
        Serial.print("gyro_body_rps[0]: ");Serial.println(gyro_body_rps[0],5);
        Serial.print("gyro_body_rps[1]: ");Serial.println(gyro_body_rps[1],5);
        Serial.print("gyro_body_rps[2]: ");Serial.println(gyro_body_rps[2],5);
        Serial.print("acc_body_mps2[0]: ");Serial.println(acc_body_mps2[0],5);
        Serial.print("acc_body_mps2[1]: ");Serial.println(acc_body_mps2[1],5);
        Serial.print("acc_body_mps2[2]: ");Serial.println(acc_body_mps2[2],5);        Serial.print("mag_body_uT[0]:");Serial.println(mag_body_uT[0],5);
        Serial.print("mag_body_uT[1]: ");Serial.println(mag_body_uT[1],5);
        Serial.print("mag_body_uT[2]: ");Serial.println(mag_body_uT[2],5);
        Serial.print("quat_BL_[0]: ");Serial.println(quat_BL_[0],5);
        Serial.print("quat_BL_[1]: ");Serial.println(quat_BL_[1],5);
        Serial.print("quat_BL_[2]: ");Serial.println(quat_BL_[2],5);
        Serial.print("quat_BL_[3]: ");Serial.println(quat_BL_[3],5);
        Serial.print("a_ENU_mps2_[0]: ");Serial.println(a_ENU_mps2_[0],5);
        Serial.print("a_ENU_mps2_[1]: ");Serial.println(a_ENU_mps2_[1],5);
        Serial.print("a_ENU_mps2_[2]: ");Serial.println(a_ENU_mps2_[2],5);
        Serial.print("v_ENU_ms_[0]: ");Serial.println(v_ENU_ms_[0],5);
        Serial.print("v_ENU_ms_[1]: ");Serial.println(v_ENU_ms_[1],5);
        Serial.print("v_ENU_ms_[2]: ");Serial.println(v_ENU_ms_[2],5);
        Serial.print("p_ENU_m_[0]: ");Serial.println(p_ENU_m_[0],5);
        Serial.print("p_ENU_m_[1]: ");Serial.println(p_ENU_m_[1],5);
        Serial.print("p_ENU_m_[2]: ");Serial.println(p_ENU_m_[2],5);
        
        Serial.print("Roll : ");Serial.println(euler_body_rad_[0]*RAD2DEG,3);
        Serial.print("Pitch : ");Serial.println(euler_body_rad_[1]*RAD2DEG,3);
        Serial.print("Yaw : ");Serial.println(euler_body_rad_[2]*RAD2DEG,3);
