...
private:
    ...
    static void IRAM_ATTR onISM6HG256Int1Trampoline();
    void IRAM_ATTR onISM6HG256Int1();
    static void IRAM_ATTR onBMP585IntTrampoline();
    void IRAM_ATTR onBMP585Int();
    static void IRAM_ATTR onMMC5983MAIntTrampoline();
    void IRAM_ATTR onMMC5983MAInt();
};
