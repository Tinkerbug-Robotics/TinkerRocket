...
//  Constructor
// ---------------------------------------------------------------------------
TR_INA230::TR_INA230(uint8_t addr)
    : _dev(nullptr),
      _addr(addr),
      _current_lsb_A(0.0f)
{}
...
// ---------------------------------------------------------------------------
//  begin – add device to an existing master bus and probe
// ---------------------------------------------------------------------------
TR_INA230Status TR_INA230::begin(i2c_master_bus_handle_t bus,
                                 uint32_t clock_hz)
{
...
// ---------------------------------------------------------------------------
//  Low-level I2C register access using new ESP-IDF i2c_master API
