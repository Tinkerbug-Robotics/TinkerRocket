...
#define SPI_NAND_FLASH_FORESEE_MI     0xCD
...
// FORESEE / Longsys
#define FORESEE_DI_53                 0x53   // F35SQB004G (4Gbit), device-ID byte 1
...
/**
 * @brief Initialize FORESEE / Longsys NAND flash (manufacturer 0xCD)
 */
