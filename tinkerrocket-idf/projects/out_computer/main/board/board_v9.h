...
//     the same enable (its GPIO5, net P4_EN_HOLD), which FC firmware HOLDS
//     while INFLIGHT (#848) — so dropping PWR_PIN powers the FC down on the
//     ground, but NOT during a flight; see
//     flight_computer/main/board/board_v9.h for the hold/release policy.
...
struct board_pins
{
    ...
    // V9 has no supercap. On V10 the sense lands on the P4 (pad 18,
    // GPIO17), not on this processor.
